<%@ Page Title="" Language="C#" MasterPageFile="~/formmain.master" AutoEventWireup="true" CodeFile="formtimkiemHĐ.aspx.cs" Inherits="formtimkiemHĐ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            <td>
                <table style="width:100%;">
                    <tr>
                        <td class="auto-style7" colspan="6">Tìm kiếm hợp đồng:</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style12">
                            <asp:RadioButton ID="RadioButton3" runat="server" Text="Tìm kiếm HĐ theo mã LX" />
                        </td>
                        <td>
                            <asp:RadioButton ID="RadioButton2" runat="server" Text="Tìm kiếm HĐ theo mã KH" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
