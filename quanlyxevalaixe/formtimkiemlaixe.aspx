<%@ Page Title="" Language="C#" MasterPageFile="~/formmain.master" AutoEventWireup="true" CodeFile="formtimkiemlaixe.aspx.cs" Inherits="formtimkiemlaixe" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                <table style="width:100%;">
                    <tr>
                        <td class="auto-style7" colspan="6">Tìm kiếm lái xe:</td>
                    </tr>
                    <tr>
                        <td class="auto-style9">&nbsp;</td>
                        <td class="auto-style10">
                            <asp:RadioButton ID="RadioButton4" runat="server" Text="Tìm kiếm theo mã lái xe" />
                        </td>
                        <td class="auto-style13">
                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Tìm kiếm theo tên lái xe" />
                        </td>
