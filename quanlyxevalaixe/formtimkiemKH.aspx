<%@ Page Title="" Language="C#" MasterPageFile="~/formmain.master" AutoEventWireup="true" CodeFile="formtimkiemKH.aspx.cs" Inherits="formtimkiemKH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            <td>
                <table style="width:100%;">
                    <tr>
                        <td class="auto-style7" colspan="6">Tìm kiếm khách hàng:</td>
                    </tr>
                    <tr>
                        <td class="auto-style9">&nbsp;</td>
                        <td class="auto-style10">
                            <asp:RadioButton ID="RadioButton4" runat="server" Text="Tìm kiếm theo mã KH" />
                        </td>
                        <td class="auto-style13">
                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Tìm kiếm theo tên KH" />
                        </td>
