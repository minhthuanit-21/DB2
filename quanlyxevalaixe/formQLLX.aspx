<%@ Page Title="" Language="C#" MasterPageFile="~/formmain.master" AutoEventWireup="true" CodeFile="formQLLX.aspx.cs" Inherits="formQLLX" %>
                ...
                <table class="auto-style9">
                    <tr>
                        <td class="auto-style10" colspan="6">
                            <asp:Label ID="Label1" runat="server" Text="Quản lý lái xe"></asp:Label>
                            :</td>
                    </tr>
                    <tr>
                        <td class="auto-style15">&nbsp;</td>
                        <td class="auto-style11">Mã lái xe:</td>
                    ...
                    <tr>
                        <td class="auto-style15">&nbsp;</td>
                        <td class="auto-style11">Tên lái xe:</td>
                        <td class="auto-style13">
                    ...
                    <tr>
                        ...
                        <td class="auto-style12">Ngày nhận việc:</td>
                        <td class="auto-style14">
                    ...
                    <tr>
                        ...
                        <td class="auto-style12">Tình trạng lái xe</td>
                        <td class="auto-style14">
                    ...
                    <tr>
                        <td class="auto-style15">&nbsp;</td>
                        <td class="auto-style1" colspan="5"><span class="auto-style2"><strong>QUẢN LÝ THÔNG TIN LÁI XE</strong></span></td>
                    </tr>
                    <tr>
                        <td class="auto-style15">&nbsp;</td>
                        <td colspan="5">
