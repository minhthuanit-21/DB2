<%@ Page Title="" Language="C#" MasterPageFile="~/trangchu.master" AutoEventWireup="true" CodeFile="formQLKH.aspx.cs" Inherits="formQLKH" %>
                ...
                <table class="auto-style9">
                    <tr>
                        <td class="auto-style10" colspan="6">
                            <asp:Label ID="Label1" runat="server" Text="Quản lý khách hàng"></asp:Label>
                            :</td>
                    </tr>
                    <tr>
                        <td class="auto-style15">&nbsp;</td>
                        <td class="auto-style11">Mã khách hàng:</td>
